...
/** 此处后端没有提供注释 GET /user/admin/list */
export async function list(options?: { [key: string]: any }) {
  return request<API.BaseResponseListUserVO>('/user/admin/list', {
    method: 'GET',
    ...(options || {}),
  })
}

/** 此处后端没有提供注释 GET /user/admin/page */
export async function page(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.pageParams,
  options?: { [key: string]: any }
) {
  return request<API.PageUser>('/user/admin/page', {
    method: 'GET',
    params: {
      ...params,
      page: undefined,
...
/** 此处后端没有提供注释 PUT /user/admin/update */
export async function update(body: API.User, options?: { [key: string]: any }) {
  return request<boolean>('/user/admin/update', {
    method: 'PUT',
    headers: {
...
/** 此处后端没有提供注释 GET /user/getCurUser */
export async function getCurUser(options?: { [key: string]: any }) {
  return request<API.BaseResponseUserVO>('/user/getCurUser', {
    method: 'GET',
    ...(options || {}),
  })
}
...
export async function logout(options?: { [key: string]: any }) {
  return request<API.BaseResponseUserVO>('/user/logout', {
    method: 'GET',
    ...(options || {}),
  })
}
